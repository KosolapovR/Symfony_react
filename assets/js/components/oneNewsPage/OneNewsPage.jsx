...
import {getOneNews, hideLoaderAC, showLoaderAC} from "../../reducers/NewsReducer";
import {
    ListItemAvatar,
    ListItem,
    ListItemText,
...
function OneNewsPage({match, location, history, ...props}) {
    ...
    let comments;
    props.news.comments ?
        comments = props.news.comments.map(c => <Box key={c.id}><ListItem alignItems="flex-start">

                <ListItemAvatar>
                    <Avatar alt={c.user.name}
